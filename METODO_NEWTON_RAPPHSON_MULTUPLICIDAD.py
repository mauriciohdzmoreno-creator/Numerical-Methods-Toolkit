#METODO NEWTON - RAPHSON (SE CONOCE LA MULTIPLICIDAD)
...
#VALOR DE LA MULTIPLICIDAD
m=2
print("El Valor de la multiplicidad es:",m)
...
#SE IMPRIME LA RAIZ OBTENIDA EN EL METODO PASADO
print("La raiz obtenida usando el metodo sin multiplicidad fue : 1.999994530354228")
#SE IMPRIME LA RAIZ OBTENIDA EN ESTE METODO Y EL NUMERO DE LA ITERACION
print("LA RAIZ APROXIMADA ES:   ",x) 
print("El numero de iteracoines fue de  :",i)


#SE OBTIENE E IMPRIME EL ERROR DE LA RAIZ DEL METODO PASADO
error_nor= abs((2-1.999994530354228)/2)*100
print("El error porcentual del metodo normal fue: ",error_nor,"%")

#SE OBTIENE E IMPRIME EL ERROR DEL METODO ACTUAL
error_mult= abs((2-x)/2)*100
print("El error porcentual del metodo con multiplicidad fue: ",error_mult,"%")

#SE COMPARAN LOS ERRORES
if error_nor > error_mult:
    print("El metodo con multiplicidad fue mas preciso")
    
else: 
    print("El metodo normal fue mas preciso")