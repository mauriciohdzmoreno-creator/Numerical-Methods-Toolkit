...
for i in range(0,G+1,1):
    ...
    if i == G:
        ...
        Cons= int(input("INGRESE EL VALOR DE LA CONSTANTE:     "))
        expr = expr + Cons
    else:     
...
yy3 = sympy.diff(y2 , x)
print("La segunda derivada de la función ingresada es:     ",yy3)
...
while (E > error):
    ...
    z1 = y.subs(x,q) * y2.subs(x,q)
    z2 = ( y2.subs(x,q) )**2 - ( y.subs(x,q) * yy3.subs(x,q) )
